...
public class POSTagCounter {
    ...
    public static void main(String[] args)  {
        ...
        final POSTagCounter tagCounter=new POSTagCounter();
        try {
            tagCounter.parse("model/german-fast.tagger","src/main/resources/Der_Prozess.txt");
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void parse (final String model, final String filename) throws Exception{
        // if (args.length != 2) {
